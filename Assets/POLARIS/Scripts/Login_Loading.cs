...
public class Login_Loading : LoadingBase
{
    public static bool firstTime = true;
    public LoadingWindow window;
    UserManager userManager;
    VisualElement fullElement;
    ...
    private void OnFoundSession(object o, EventArgs e)
    {
    ...
    private IEnumerator DisappearAnimation(LoadingWindow window)
    {
        StopLoop(window);

        //make load disappear
        yield return new WaitForSeconds(0.5f);
        window.errorLabel.style.translate = new Translate(0, Length.Percent(100));
